...
I found the description and illustration of this solution in the online course 
"Algorithms, part II" - Robert Sedgewick, Kevin Wayne

These lectures are actuals:
12 - Minimum Spanning Trees - Introduction
13 - Minimum Spanning Trees - Greedy Algorithm
14 - Minimum Spanning Trees - Edge-Weighted Graph API
15 - Minimum Spanning Trees - Kruskal's Algorithm

It could be found on youtube, for example, this one:
...
The source code (Kruskal) in Java:
